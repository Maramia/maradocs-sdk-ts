 ...
 */
const PdfImgPositionSchema = z
  .enum(["center"])
  .describe("Position of image in blank page");
...
export const RelativePositionSchema = z
  .object({
    x: z
      ...
      .min(0.0)
      .max(1.0)
      .describe("Relative position on the x-axis (0.0 to 1.0)"),
    y: z
      .number()
      .min(0.0)
      .max(1.0)
      .describe("Relative position on the y-axis (0.0 to 1.0)"),
  })
 ...
 */
export const QuadrilateralSchema = z
  .object({
  ...
  .refine(
    (data) => {
      return (
        data.top_left.x <= data.top_right.x &&
 ...
 */
export const ImgValidateRequestSchema = z
  .object({
    unvalidated_file_handle: UnvalidatedFileHandleSchema.describe(
      "Handle to the unvalidated image file"
    ),
  })
 ...
 */
export const ImgValidateResponseOkSchema = z
  .object({
 ...
 */
export const ImgValidateResponseErrorSchema = z
  .object({
    class_name: z.literal("ImgValidateResponseError"),
    error: z.string().describe("Error message"),
  })
  .describe("Image validation error");
export type ImgValidateResponseError = z.infer<
  typeof ImgValidateResponseErrorSchema
>;

/**
 * Image validation failed due to virus detection
 */
export const ImgValidateResponseVirusSchema = z
  .object({
...
export type ImgValidateResponseVirus = z.infer<
  typeof ImgValidateResponseVirusSchema
>;

/**
 * Response to an image validation request (discriminated union)
 */
export const ImgValidateResponseSchema = z
  .object({
 ...
 */
export const ImgOrientationRequestSchema = z
  .object({
 ...
 */
export const ImgOrientationResponseSchema = z
  .object({
    rotated_img_handle: ImgHandleSchema.describe(
      "Handle to the auto-rotated image"
    ),
    orientation: DiscreteAngleSchema.describe("Detected orientation angle"),
  })
  .describe("Image orientation detection response");
export type ImgOrientationResponse = z.infer<
  typeof ImgOrientationResponseSchema
>;
 ...
 */
export const ImgRotateRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the image to rotate"),
    rotate: DiscreteAngleSchema.describe(
      "Angle to rotate the image counter-clockwise"
    ),
  })
 ...
 */
export const ImgRotateResponseSchema = z
  .object({
 ...
 */
export const ImgThumbnailRequestSchema = z
  .object({
    ...
    max_width: z
      ...
      .int()
      .positive()
      .describe("Maximum width of the thumbnail in pixels"),
    max_height: z
      .number()
      .int()
      .positive()
      .describe("Maximum height of the thumbnail in pixels"),
  })
 ...
 */
export const ImgThumbnailResponseSchema = z
  .object({
 ...
 */
export const ImgToPngRequestSchema = z
  .object({
 ...
 */
export const ImgToPngResponseSchema = z
  .object({
 ...
 */
export const ImgToJpegRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the image to convert"),
    quality: z
      .number()
      ...
      .max(100)
      .default(75)
      .describe("JPEG quality (0-100). Default: 75"),
    progressive: z
      .boolean()
      .default(false)
      .describe("Use progressive JPEG encoding. Default: false"),
  })
 ...
 */
export const ImgToJpegResponseSchema = z
  .object({
...
export const EmbeddingOptionsSchema = z
  .object({
    ...
    position: PdfImgPositionSchema.default("center").describe(
      "Position of the image in the page. Default: center"
    ),
  })
 ...
 */
const ImgToPdfOptionsBaseSchema = z
  .object({
    img_quality: PdfImgQualitySchema.default(70).describe(
      "Image quality in PDF (1-100). Default: 70"
    ),
    img_color: PdfImgColorSchema.default("original").describe(
      "Color mode. Default: original"
    ),
    max_size: PdfPageSizeSchema.default({ width: 210, height: 297 }).describe(
      "Max size (width, height) in mm. Default: A4 (210x297)"
    ),
    max_dpi: DPISchema.default(120).describe(
      "Maximum DPI for downsampling. Default: 120"
    ),
    min_dpi: DPISchema.default(100).describe(
      "Minimum DPI for sizing. Default: 100"
    ),
    embed_in_blank_page: EmbeddingOptionsSchema.optional()
      .default({ size: { width: 210, height: 297 }, position: "center" })
      .describe(
        "Embed in a blank page of specified size. Default: A4 (210x297) center"
      ),
  })
 ...
 */
export const ImgToPdfOptionsSchema = ImgToPdfOptionsBaseSchema.refine(
  (data) => {
 ...
 */
export const ImgToPdfRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the image to convert"),
    options: ImgToPdfOptionsBaseSchema.partial()
      .optional()
      .describe("PDF conversion options"),
  })
 ...
 */
export const ImgToPdfResponseSchema = z
  .object({
 ...
 */
export const ImgFindDocumentsRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the image to analyze"),
  })
  .describe("Document detection request");
export type ImgFindDocumentsRequest = z.infer<
  typeof ImgFindDocumentsRequestSchema
>;

/**
 * Detected document quadrilateral with confidence score
 */
export const ImgFindDocumentsQuadrilateralSchema = z
  .object({
    quadrilateral: QuadrilateralSchema.describe(
      "Boundaries of the detected document"
    ),
    confidence: ConfidenceSchema.describe("Confidence in the detection"),
  })
  .describe("Detected document with boundaries");
export type ImgFindDocumentsQuadrilateral = z.infer<
  typeof ImgFindDocumentsQuadrilateralSchema
>;

/**
 * Response to a document detection request
 */
export const ImgFindDocumentsResponseSchema = z
  .object({
    documents: z
      .array(ImgFindDocumentsQuadrilateralSchema)
      .describe("List of detected documents"),
  })
  .describe("Document detection response");
export type ImgFindDocumentsResponse = z.infer<
  typeof ImgFindDocumentsResponseSchema
>;
 ...
 */
export const ImgExtractQuadrilateralRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the source image"),
    quadrilateral: QuadrilateralSchema.describe("Region to extract"),
  })
  .describe("Quadrilateral extraction request");
export type ImgExtractQuadrilateralRequest = z.infer<
  typeof ImgExtractQuadrilateralRequestSchema
>;

/**
 * Response to a quadrilateral extraction request
 */
export const ImgExtractQuadrilateralResponseSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the extracted image"),
  })
  .describe("Quadrilateral extraction response");
export type ImgExtractQuadrilateralResponse = z.infer<
  typeof ImgExtractQuadrilateralResponseSchema
>;
 ...
 */
export const ImgOcrToPdfRequestSchema = z
  .object({
 ...
 */
export const ImgOcrToPdfResponseSchema = z
  .object({
    pdf_handle: PdfHandleSchema.describe(
      "Handle to the PDF with OCR text overlay"
    ),
  })
 ...
 */
export const ImgToOdtOptionsSchema = z
  .object({})
  .describe("ODT conversion options");
 ...
 */
export const ImgOcrToOdtRequestSchema = z
  .object({
    img_handle: ImgHandleSchema.describe("Handle to the image for OCR"),
 ...
 */
export const ImgOcrToOdtResponseSchema = z
  .object({
...
/**
 * Utility function to extract the image handle from a validation response.
 * Returns the image handle if validation was successful.
 ...
 * @param response - The image validation response
 * @returns The validated image handle
 * @throws {ValidationErrorException} If validation failed due to an error
 * @throws {ValidationVirusException} If a virus was detected
 */
export function okImg(response: ImgValidateResponse): ImgHandle {
  if (response.response.class_name === "ImgValidateResponseOk") {
    return response.response.img_handle;
  } else if (response.response.class_name === "ImgValidateResponseError") {
    throw new ValidationErrorException(response.response.error);
  } else if (response.response.class_name === "ImgValidateResponseVirus") {
